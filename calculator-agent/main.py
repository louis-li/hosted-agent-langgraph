...
#os.environ["AZURE_AI_PROJECT_ENDPOINT"] = "https://2026agent-nc.services.ai.azure.com/api/projects/proj-default"
# Define tools
@tool
...
def llm():
    try:
        deployment_name = os.getenv("AZURE_AI_MODEL_DEPLOYMENT_NAME", "gpt-5.4-mini")
